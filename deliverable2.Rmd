...
######### more typology code
ggplot() +
  geom_sf(data =st_union(nhood), fill = "steelblue1", color="transparent") +
  geom_sf(data = CBD_bound, fill = "steelblue" , color="transparent") +
  geom_sf(data = UTAustin_bound, fill = "steelblue4", color="transparent")+
  mapTheme()
``` 
