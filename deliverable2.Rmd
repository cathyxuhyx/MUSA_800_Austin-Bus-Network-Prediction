...
### 3.3.2 Selecting the Best Buffer

**********(we select three buffer sizes to test according our domain knowledge)
...
We tested the model with the 
![](../markdown_img/22/Gene_rf.JPG){width=500px}

### 4.1.2 Scenario 1: What is the effect of UT Austin West Campus Development?

![](../markdown_img/s1_1.png)

![](../markdown_img/s1_2.png){width=500px}

### 4.1.3 Scenario 2: What is the effect of East Riverside Development?

![](../markdown_img/s2_1.png)

![](../markdown_img/s2_2.png){width=500px}

### 4.1.4 Scenario 3: What is the effect of Mueller Austin Housing Project?
...
nhood0 <- nhood %>% left_join(lm_model0 %>% 
            na.omit() %>%
            group_by(label) %>% 
            summarise(Pred.err.sum = sum(pred_err)) %>% 
            select(label, Pred.err.sum) %>%
